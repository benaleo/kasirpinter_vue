...
const routes = [
    ...
    {path: '/login', name: 'Login', component: Login, meta: {isPublic: true, preventAuthed: true}},
    {path: '/register', name: 'Register', component: Register, meta: {isPublic: true, preventAuthed: true}},
    ...
    {
        path: '/v1/company', name: 'Company', component: Company, children: [
            {path: 'create', name: 'Company Create', component: FormRegister}
        ], meta: {requiresAuth: true}
    },
