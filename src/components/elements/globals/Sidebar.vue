...
const menus: MenuType[] = [
  {
    group: 'Dashboard',
    items: [{ title: 'Home', url: '/v1/dashboard', component: Dashboard, icon: 'Home' }],
  },
  {
    group: 'Toko',
    items: [
  ...
  {
    group: 'Laporan',
    items: [{ title: 'Lapor Pajak', url: '/v1/tax', component: Dashboard, icon: 'Calendar' }],
  },
  {
    group: 'Admin',
    items: [
